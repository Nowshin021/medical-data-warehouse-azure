# medical-data-warehouse-azure
Description of medical sample data , how I Have added the data in AZURE Data lake S2 , transformed the data suing Pyspark , and made a power bi dashboard
